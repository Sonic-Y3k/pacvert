...
_CONFIG_DEFINITIONS = {
    ...
    'CHECK_GITHUB': (bool, 'General', True),
    'CHECK_GITHUB_INTERVAL': (int, 'General', 360),
    'CHECK_GITHUB_ON_STARTUP': (bool, 'General', True),
    'CODEC_AVC_ADDITIONALOPT': (dict, 'CodecSettings', {}),
    'CODEC_AVC_AUTOMAXRATE': (bool, 'CodecSettings', True),
    'CODEC_AVC_BUFSIZE': (int, 'CodecSettings', -1),
    'CODEC_AVC_MAXRATE': (int, 'CodecSettings', -1),
    'CODEC_AVC_PRESET': (str, 'CodecSettings', 'slow'),
    'CODEC_AVC_PROFILE': (str, 'CodecSettings', 'high'),
    'CODEC_AVC_QUALITY': (float, 'CodecSettings', 18.0),
    'CODEC_AVC_TUNE': (str, 'CodecSettings', 'film'),
    'CODEC_HEVC_ADDITIONALOPT': (dict, 'CodecSettings', {'pix_fmt': 'yuv420p10', 'x265-params': 'aq-mode=3'}),
    ...
    'HTTP_PROXY': (bool, 'General', False),
    'HTTP_ROOT': (str, 'General', ''),
    'HTTP_USERNAME': (str, 'General', ''),
    'INTERFACE': (str, 'General', 'default'),
    'LOG_BLACKLIST': (bool, 'General', True),
    'LOG_DIR': (str, 'General', ''),
    'OUTPUT_DIRECTORY': (str, 'General', ''),
    'SCAN_DIRECTORIES': (bool, 'General', False),
    ...
    'VERIFY_SSL_CERT': (bool, 'Advanced', True),
}
